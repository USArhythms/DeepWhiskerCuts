...
class Trial:
    def __init__(self,triali):
        ...
        eye_dlc_csv = re.compile(str(triali)+rf'DLC_\w+shuffle{shuffle}_\d+.csv')
        eye_dlc_filtered_csv = re.compile(str(triali)+rf'DLC_\w+shuffle{shuffle}_\d+_filtered.csv')
        eye_dlc_h5 = re.compile(str(triali)+rf'DLC_\w+shuffle{shuffle}_\d+.h5')
        eye_dlc_pickle = re.compile(str(triali)+rf'DLC_\w+shuffle{shuffle}_\w+.pickle')
