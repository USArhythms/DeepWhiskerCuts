...
def processs_side_view_data(data_path):
    ...
    eye_config_file ='/data/Eye 482_EPL-Arash-2022-05-24/config.yaml';
    ...
    deeplabcut.filterpredictions(eye_config_file,eye_videos,shuffle=3)
...
def processs_top_view_data(data_path):
    Whisker_configfile =r'\\dk-server.dk.ucsd.edu\afassihizakeri\DLC\WhiskerMuscimol-xx-2022-10-10\config.yaml';
    head_config_file =r'\\dk-server.dk.ucsd.edu\afassihizakeri\DLC\SC_Muscimol_2019-Arash_2-2022-10-03\config.yaml';
    head_config_file =r'\\dk-server.dk.ucsd.edu\afassihizakeri\DLC\SC_Muscimol_2019-Arash_2-2022-10-03\config.yaml';
    # destination='/net/dk-server/afassihizakeri/SC_Movies/ar32motor/2021_08_02/Side'
    ...
    #deeplabcut.analyze_videos(head_config_file,text_files,shuffle=3, save_as_csv=True )
   # deeplabcut.filterpredictions(head_config_file,text_files,shuffle=3)
    ...
    deeplabcut.analyze_videos(Whisker_configfile,XfilesL,shuffle=1, save_as_csv=True)
    deeplabcut.filterpredictions(Whisker_configfile,XfilesL,shuffle=1)
    deeplabcut.analyze_videos(Whisker_configfile,XfilesR,shuffle=1, save_as_csv=True)
    deeplabcut.filterpredictions(Whisker_configfile,XfilesR,shuffle=1)
    # shutil.copytree( data_path,destination, ignore=shutil.ignore_patterns('*.avi'),copy_function = shutil.copy)
