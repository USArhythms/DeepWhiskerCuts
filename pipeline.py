...
def processs_side_view_data(data_path):
    ...
    #extract_eye_videos(data_path,'DLC_resnet50_SideviewLeft_Feb2022Feb8shuffle2_500000')
    #extract_eye_videos(data_path,'DLC_resnet50_SideviewLeft_Feb2022Feb8shuffle1_271000')
    print(this_computer['eye_config'])
    ...
    deeplabcut.analyze_videos(this_computer['eye_config'],eye_videos,shuffle=2, save_as_csv=True )
    deeplabcut.filterpredictions(this_computer['eye_config'],eye_videos,shuffle=2)
