...
def processs_side_view_data(data_path):
    side_view_config_file =r'\\dk-server.dk.ucsd.edu\afassihizakeri\DLC\SideviewLeft_Feb2022-Arash-2022-02-08\config.yaml';
    eye_config_file =r'\\dk-server.dk.ucsd.edu\afassihizakeri\DLC\482_Eye-Arash-2022-04-26\config.yaml';
...
def processs_top_view_data(data_path):
    top_view_config_file =r'\\dk-server.dk.ucsd.edu\afassihizakeri\DLC\WhiskerMuscimol-xx-2022-10-10\config.yaml';
